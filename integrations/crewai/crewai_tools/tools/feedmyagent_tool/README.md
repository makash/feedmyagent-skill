...
```python
from crewai_tools import FeedMyAgentLatestTool, FeedMyAgentSearchTool, FeedMyAgentReportTool
...
See `examples/daily_security_briefing.py` in this repo for a full crew.
